...
export default function Footer() {
  return (
    <footer className="flex w-full h-fit p-2 md:px-16 flex-row flex-wrap items-center justify-center gap-x-12 gap-y-3  py-2  px-3 text-center md:justify-between">
      <Typography>
        &copy; {YEAR}{" "}
